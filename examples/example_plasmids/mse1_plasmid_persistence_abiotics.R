...
results <- foreach(i = 1:length(transfer_rate), 
                   .packages = c("data.table", "tidyr", "bit64")) %dopar% {
...
tiff("./documentation/plasmid_example_outputs/mse1_abiotic_critical_transfer_0.9.tiff",
...
tiff("./documentation/plasmid_example_outputs/mse1_abiotic_critical_transfer_0.8.tiff",
     res = 300, units = "cm", width = 25, height = 15)
print(
  ggplot(d_cells,
         mapping = aes(x = step/24, 
...
tiff("./documentation/plasmid_example_outputs/mse1_abiotic_critical_transfer_0.7.tiff",
     res = 300, units = "cm", width = 25, height = 15)
print(
  ggplot(d_cells,
         mapping = aes(x = step/24, 

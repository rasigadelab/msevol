...
setwd("C:/Users/Lenuzza/Desktop/msvr") 
...
source("msvr_fun/cfg_funcs v0.03.R")
...
tiff("./documentation/arch/tutorial_intro_growth.tiff",
...
tiff("./documentation/arch/tutorial_intro_death.tiff",
...
tiff("./documentation/arch/tutorial_intro_plasmid_transfer.tiff",
     unit = "cm", res = 300, width = 17, height = 10)
plot(plot_cells)
dev.off()
...
tiff("./documentation/arch/tutorial_intro_plasmid_transfer_number.tiff",
...
tiff("./documentation/arch/tutorial_intro_plasmid_loss.tiff",
     unit = "cm", res = 300, width = 25, height = 10)
ggpubr::ggarrange(
  plot_cells ,
...
tiff("./documentation/arch/tutorial_intro_cell_diffusion.tiff",
     unit = "cm", res = 300, width = 17, height = 10)
  plot_cells
dev.off()

...
tutorial_path <- paste(dirname(getwd()),
                       "/examples/documentation/toy_example_outputs",
                       sep = "")
cleanup_csv <- TRUE
...
if(run_for_tutorial){
  visSave(mse1.plot_graph(prm, layout = "hr"),
          file =paste(tutorial_path,"/toy_exemple_initial_graph_hierachical.html", sep = ""))

  visSave(mse1.plot_graph(prm, layout = "fr"),
          file =paste(tutorial_path,"/toy_exemple_initial_graph_frlayout.html", sep = ""))
